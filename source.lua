...
ImageButton.Image = "rbxassetid://116576747706989";
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://116576747706989";
	Title.Parent = Frame;
...
function Update:StartLoad()
	...
	TitleLoader.Text = "Valtheros Hub ";
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Valtheros Hub ") then
			makefolder("Valtheros Hub ");
		end;
		if not isfolder("Valtheros Hub /Library/") then
			makefolder("Valtheros Hub /Library/");
		end;
		if not isfile(("Valtheros Hub /Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Valtheros Hub /Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Valtheros Hub /Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Valtheros Hub /Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Valtheros Hub /Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	CreateButton("Reset Config", function()
		if isfolder("Valtheros Hub ") then
			delfolder("Valtheros Hub ");
		end;
